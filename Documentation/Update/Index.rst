...
Execute :ref:`upgrade wizard <t3coreapi:postupgradetasks>` to update old Sysfolders.
...
Use the :ref:`upgrade wizard <t3coreapi:postupgradetasks>` to migrate the old recipient list types.
